...
public class MainActivity extends BaseActivity implements MainView{
    ...
    @Override
    public void initRecyclerView(List<UNote> notes){
        recyclerAdapter = new NotesAdapter(notes, this);
        recyclerView.setHasFixedSize(true);
        recyclerAdapter.setOnInViewClickListener(R.id.notes_item_root,
                new BaseRecyclerViewAdapter.onInternalClickListenerImpl<UNote>() {
                    @Override
                    public void OnClickListener(View parentV, View v, Integer position, UNote values) {
    ...
    @Override
    public void switchNoteTypePage(List<UNote> notes) {
    ...
    @Override
    public void updateNote(UNote note) {
    ...
    @Override
    public void showNormalPopupMenu(View view, UNote note) {
    ...
    @Override
    public void showTrashPopupMenu(View view, UNote note) {
        PopupMenu popup = new PopupMenu(this, view);
        popup.getMenuInflater()
    ...
    @Override
    public void showDeleteForeverDialog(final UNote note){
